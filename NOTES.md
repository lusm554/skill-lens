...
[2025 Dec 2 18:42] Реализация Medallion Architecture в Data Lakehouse (гибрид Data Lake и Data Warehouse). Слои Bronze/Silver/Gold + по необходимости слой Serving - реплицированные данные из Gold в СУБД под специфику потребителя данных (например под приложение Postgres). Как способ упра
